        ...
        const fetchDetails = async () => {
            ...
            try {
                const [flightResponse, passengerResponse] = await Promise.all([
                    axios.get(`${import.meta.env.VITE_APP_API_URL}/my/flight/${reservationId}/flight-detail`, { headers }),
                    axios.get(`${import.meta.env.VITE_APP_API_URL}/my/flight/${reservationId}/passenger-detail`, { headers }),
                ]);
