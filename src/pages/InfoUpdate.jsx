...
import { Layout, Typography, Button, Radio, Card, Row, Col, Menu, Input } from "antd";
        ...
        <Layout style={{ minHeight: '80vh', background: 'white', width: '100%', maxWidth: '950px', margin: '0 auto', paddingLeft: '20px', paddingRight: '20px' }}>
            ...
            <Layout>
                ...
                <Content style={{ maxWidth: "950px", margin: "0 auto", padding: "24px", background: 'white' }}>
                    ...
                    <Card
                        style={{ width: '100%', borderRadius: '8px', border: '1px solid #d9d9d9', marginBottom: "24px", height: '250px' }}
                        bodyStyle={{ padding: 0 }}
                    >
                    ...
                    <div style={{ display: "flex", justifyContent: "flex-end", marginTop: "24px" }}>
                        <Button onClick={handleCancel} style={{ marginRight: "16px", backgroundColor: "white", borderColor: "black", color: "black" }}>
                            취소
                        </Button>
                        <Button type="primary" onClick={handleSave} style={{ backgroundColor: "#007BFF", borderColor: "#007BFF", color: "white" }}>
                            저장
                        </Button>
                    </div>
                </Content>
